...
#if XBOX
#include "../resources/OpenBOR_Menu_480x272_Xbox_png.h"
#include "../resources/OpenBOR_Menu_320x240_Xbox_png.h"
#else
...
void initMenu(int type)
{
	...
	flags = isFull?(SDL_SWSURFACE|SDL_FULLSCREEN):(SDL_SWSURFACE);
#else
	flags = SDL_SWSURFACE;
#endif
...
#ifdef XBOX
	printText((isWide ? 23 : 4),(isWide ? 251 : 226), WHITE, 0, 0, "Start Game");
#ifndef XBOX360
	printText((isWide ? 150 : 84),(isWide ? 251 : 226), WHITE, 0, 0, "BGM Player");
#endif
	printText((isWide ? 270 : 164),(isWide ? 251 : 226), WHITE, 0, 0, "View Logs");
	printText((isWide ? 390 : 244),(isWide ? 251 : 226), WHITE, 0, 0, "Quit Game");
#else
